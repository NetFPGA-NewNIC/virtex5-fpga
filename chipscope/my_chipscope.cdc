...
Project.filter<0>=*/tx_wr_pkt_to_bram_mod/*
Project.filter<10>=*tx_underrun*
Project.filter<11>=*clk156*
Project.filter<12>=*clk_156*
Project.filter<13>=*cfg_interrupt*
Project.filter<14>=*resend*
Project.filter<15>=*trn_tbuf_av*
Project.filter<16>=*trn_tsrc_rdy_n*
Project.filter<17>=*trn_teof_n*
Project.filter<18>=*trn_tsof_n*
Project.filter<1>=*counter_mon*
Project.filter<2>=
Project.filter<3>=*interrupt*
Project.filter<4>=*diff*
Project.filter<5>=*rx_good_frame*
Project.filter<6>=*rx_bad_frame*
Project.filter<7>=*rx_activity*
Project.filter<8>=*tx_ack*
Project.filter<9>=*tx_start*
...
Project.unit<0>.dataChannel<161>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<0>
Project.unit<0>.dataChannel<162>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<1>
Project.unit<0>.dataChannel<163>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<2>
Project.unit<0>.dataChannel<164>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<3>
Project.unit<0>.dataChannel<165>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<4>
Project.unit<0>.dataChannel<166>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<5>
Project.unit<0>.dataChannel<167>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<6>
Project.unit<0>.dataChannel<168>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<7>
Project.unit<0>.dataChannel<169>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<8>
Project.unit<0>.dataChannel<16>=trn_rd_c<16>
Project.unit<0>.dataChannel<170>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/diff<9>
Project.unit<0>.dataChannel<171>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/waiting_data_huge_page_1
Project.unit<0>.dataChannel<172>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/waiting_data_huge_page_2
Project.unit<0>.dataChannel<173>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/read_chunk
Project.unit<0>.dataChannel<174>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/reading_huge_page_1
Project.unit<0>.dataChannel<175>=pcie_endpoint_driver_mod/tx_wr_pkt_to_bram_mod/reading_huge_page_2
